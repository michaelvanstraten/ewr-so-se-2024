...
%% HIER DIAGRAMM FÜR PYLOGSPACE(0, 5, 20, np.float16, Forward) UND PYLOGSPACE(0, 5, 20, np.float16, Kahan)
%% EINFÜGEN 

\subsubsection{Summation für Datentyp np.float64}
%% HIER DIAGRAMM FÜR PYLOGSPACE(0, 5, 20, np.float64, Forward) UND PYLOGSPACE(0, 5, 20, np.float64, Kahan)
%% EINFÜGEN
