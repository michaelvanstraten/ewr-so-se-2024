...
\begin{frame}
    \textbf{Überblick:}
    \begin{itemize}
        \item Führt Laufzeitanalyse für verschiedene Algorithmen zur Approximation von \(\pi\) durch:
              \begin{itemize}
                  \item Leibniz-Reihe, Monte Carlo, Gauss-Legendre, Chudnovsky
              \end{itemize}
        \item Misst Zeit zur Approximation von \(\pi\) auf bestimmte Dezimalstellen.
    \end{itemize}
